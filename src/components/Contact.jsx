        ...
        <div className="contact-container">
          <div className="contact-info">
            ...
            <div className="social-links">
              ...
              <a href="https://linkedin.com/in/harold-vergara-torres-639661321?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" className="social-icon"><FaLinkedin /></a>
              <a href="https://twitter.com/Santitover?t=7db1_1TEue-oJCt62hxtIQ&s=09" target="_blank" rel="noopener noreferrer" className="social-icon"><FaTwitter /></a>
